...
// function getAllgrainFoodData()
// {


//FoodOriginalData .forEach(element =>  {
...
// function getAllcaloriesFoodData(){
// FoodOriginalData.forEach(element => {
...
// });
// }
 function getAllcalorieFoodData(){
 FoodOriginalData.forEach(element => {
   if(element.calorie < 100) {
     console.log(element);
   }
...
function getAllhigtolowFoodDate(){
...
function getAlllowtohighFoodDate(){

  let arr =[];
  FoodOriginalData.forEach(element =>  {
    arr.push(element);
  })
  arr.sort((a,b) => a.protiens - b.protiens);
  console.log(arr);

}


// function getAllcalorieshighFoodData(){
//   let arr = [];
//   FoodOriginalData.forEach(element => {
//     arr.push(element);
//   })
//   arr.sort((a,b)  => b.calorie - a.calorie);
//   console.log(arr);
// }


// function getAllcalorieslowFoodData() {
//   let arr =[];
//   FoodOriginalData.forEach(element =>  {
//   arr.push(element);
//   })
